...
import { buildMathPresentation } from './utils/mathPresentation.js';
...
export function createApp(root) {
  ...
  function openHistoryItem(id) {
    ...
    stateApi.setPresentation(item.presentation || buildMathPresentation(item.task, item.resultText || item.result || ''));
    router.go('solve');
  ...
  async function handleSolve() {
    ...
    try {
      ...
      const presentation = buildMathPresentation(text, result);
      stateApi.setPresentation(presentation);
