...
import { speakText, togglePauseSpeech, stopSpeech, getSpeechStatus } from './utils/speech.js';
  ...
  function bindEvents() {
    ...
    if (stopVoiceBtn) {
      stopVoiceBtn.addEventListener('click', () => {
        const ok = stopSpeech({ onEnd: syncVoiceControls });
        syncVoiceControls();
        if (!ok) toast('Озвучка уже остановлена');
      });
    }
