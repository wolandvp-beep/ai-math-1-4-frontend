  ...
  function bindEvents() {
    ...
    if (copyBtn) {
      copyBtn.addEventListener('click', async () => {
        const text = document.getElementById('resultBox')?.dataset.copyText || stateApi.get().currentResult || '';
    ...
    if (voiceBtn) {
      voiceBtn.addEventListener('click', () => {
        const voiceText = document.getElementById('resultBox')?.dataset.voiceText || stateApi.get().currentResult;
