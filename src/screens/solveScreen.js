  ...
  return `
    <section class="screen ${state.route === 'solve' ? 'active' : ''}" data-screen="solve">
      <div class="card glass-card solve-hero-card">
        ...
        <h1 class="solve-main-title">Введите условие задачи, пример, уравнение или математический вопрос.</h1>
        ...
        <div class="row solve-actions-row">
          <button class="primary primary-wide" id="solveBtn">Начать</button>
        </div>
      </div>
      ...
      <div class="card answer-card result-card">
        ...
        <div id="resultBox" class="result">${hasResult ? state.currentResult : 'Здесь появится объяснение и ответ.'}</div>
        <div class="tool-cluster" style="margin-top:12px;">
          ...
          <div class="voice-toolbar">
            ...
            <button class="tool-btn tool-btn-icon" id="pauseVoiceBtn" aria-label="Пауза" title="Пауза">
              <span class="icon-pause" aria-hidden="true"></span>
            </button>
            <button class="tool-btn tool-btn-icon" id="stopVoiceBtn" aria-label="Стоп" title="Стоп">
