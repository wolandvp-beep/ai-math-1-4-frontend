    ...
    <section class="screen ${state.route === 'solve' ? 'active' : ''}" data-screen="solve">
      <div class="card glass-card premium-card composer-card skyline-scene-card skyline-scene-solve v23-solve-stage">
        <div class="v23-stage-grid">
          ...
          <div class="v23-side-pulse v27-solve-side">
            <div class="v23-orbit-card v27-solve-orbit-card">
              <div class="v27-sigil-wrap">
                <img class="v27-sigil" src="./src/assets/generated/solve-sigil.svg" alt="" />
              </div>
              <span class="v23-orbit-label">Solve District</span>
              <strong>Задача • Пример • Уравнение • Выражение</strong>
              <small>Световая станция разбора: вход, импульс, решение и короткое правило.</small>
            </div>
            <div class="v23-orbit-lines v27-orbit-lines"></div>
          </div>
        </div>
      ...
      <div class="card answer-card premium-card answer-premium skyline-scene-card skyline-scene-answer v23-answer-stage v27-answer-stage">
        <div class="panel-header-row v23-answer-head v27-answer-head">
          <div>
          ...
          <div class="v27-answer-head-right">
            <div class="answer-status v23-answer-status">Озвучка подключена</div>
            <div class="v27-signal-badges"><span>Core</span><span>Guide</span><span>Rule</span></div>
          </div>
        </div>
        <div class="v23-answer-frame v27-answer-frame">
          <div class="v23-answer-beam"></div>
          <div class="v27-frame-corners"></div>
          <div class="v27-response-gridline"></div>
          <div id="resultBox" class="result premium-result skyline-result-panel v23-result-panel v27-result-panel">${hasResult ? state.currentResult : 'Здесь появится объяснение задачи, примера, уравнения или выражения. Сначала будет короткая мысль, потом решение и ответ.'}</div>
        </div>
        <div class="toolbar-grid toolbar-grid-4 tool-cluster tool-cluster-premium skyline-tool-cluster v23-tool-cluster v27-tool-cluster" style="margin-top:12px;">
