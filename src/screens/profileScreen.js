export function renderProfileScreen({ t, state, session, subscription }) {
  ...
  return `
    <section class="screen ${state.route === 'profile' ? 'active' : ''}" data-screen="profile">
      <div class="hero" style="background:linear-gradient(135deg,#ff5fa2 0%, #ff8f6b 55%, #ffcd6b 120%);">
        <div class="badge">🌈 Личный раздел</div>
        <h1 style="font-size:2rem;">Профиль</h1>
        <p>Здесь собраны аккаунт, доступ, язык, семья и будущие настройки приложения.</p>
